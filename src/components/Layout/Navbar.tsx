    ...
    <nav className="glass-morphism border-b border-white/20 px-6 py-4 sticky top-0 z-50">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-display font-bold text-white text-shadow">EduAI Platform</h1>
            <p className="text-xs text-white/60 font-medium">AI-Powered Learning</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3 bg-white/10 rounded-2xl px-4 py-2 backdrop-blur-glass">
            ...
            <div className="text-sm">
              <p className="text-white font-display font-semibold">{user.name}</p>
              <p className="text-white/70 capitalize font-medium">{user.role}</p>
            </div>
          </div>
