...
import { Upload, CheckSquare, User, Users, Sparkles, BookOpen } from 'lucide-react';
...
type ActiveSection = 'upload' | 'evaluate' | 'study-plans' | 'classrooms' | 'profile';

const TeacherDashboard: React.FC = () => {
  const [activeSection, setActiveSection] = useState<ActiveSection>('upload');

  const sections = [
    { id: 'upload' as const, name: 'Upload Assignment', icon: Upload, color: 'from-primary-500 to-primary-600' },
    { id: 'evaluate' as const, name: 'Evaluate Submissions', icon: CheckSquare, color: 'from-success-500 to-success-600' },
    { id: 'study-plans' as const, name: 'Study Plans', icon: BookOpen, color: 'from-purple-500 to-pink-600' },
    { id: 'classrooms' as const, name: 'Classrooms', icon: Users, color: 'from-secondary-500 to-secondary-600' },
    { id: 'profile' as const, name: 'Profile', icon: User, color: 'from-accent-500 to-accent-600' }
  ];
            ...
            <div className="w-72 bg-white/5 p-6 border-r border-white/10 flex-shrink-0">
              <div className="mb-8">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h2 className="text-xl font-display font-bold text-white text-shadow">Teacher Dashboard</h2>
                </div>
                <p className="text-white/60 text-sm font-medium">Manage your classes and students</p>
              </div>
